                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-md-10 col-12">
                                    <form class="form-horizontal form-user-profile row mt-2" action="{{ route('contact.update', $contact->id) }}" method="POST">
                                        @method('PUT')
                                        @csrf
                                        <div class="col-8">
                                            <fieldset class="form-group">
                                                <label for="category">Jenis</label>
                                                <input type="text" class="form-control" name="category" autofocus="" value="{{$contact->category}}" disabled>
                                            </fieldset>
                                        </div>
                                        @error('category')
                                        ...
                                        <div class="col-8">
                                            <fieldset class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="link" autofocus="" value="{{$contact->link}}">
                                            </fieldset>
                                        </div>
                                        @error('link')
                                        <small style="color: red;">{{ $message }}</small>
