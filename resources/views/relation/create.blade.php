                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-md-10 col-12">
                                    <form class="form-horizontal form-user-profile row mt-2" action="{{ route('relation.store') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="col-8">
                                            <fieldset class="form-group">
                                                <label for="instance">Nama Instansi</label>
                                                <input type="text" class="form-control" id="instance" name="instance" required="" autofocus="">
                                            </fieldset>
                                        </div>
                                        @error('instance')
