...
<div class="main-menu menu-fixed menu-dark menu-bg-default rounded menu-accordion menu-shadow">
    <div class="main-menu-content"><a class="navigation-brand d-none d-md-block d-lg-block d-xl-block" href="index.html"><img class="brand-logo" alt="CryptoDash admin logo" src="{{ asset('assets/app-assets/images/ico/logo pasti.jpg') }}" /></a>
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class=" nav-item active"><a href="/relation"><i class="icon-cup"></i><span class="menu-title" data-i18n="">Data Relasi</span></a>
            </li>
                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-md-10 col-12">
                                    <form class="form-horizontal form-user-profile row mt-2" action="{{ route('relation.update', $relation->id) }}" method="POST" enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
                                        <div class="col-8">
                                            <fieldset class="form-group">
                                                <label for="instance">Nama Instansi</label>
                                                <input type="text" class="form-control" name="instance" autofocus="" value="{{$relation->instance}}" >
                                            </fieldset>
                                        </div>
                                        @error('title')
                                        ...
                                        <img src="/image/{{$relation->image}}" alt="" class="img-fluid" width="300">
                                        <div class="col-6">
                                            <fieldset class="form-group">
                                        ...
                                        <div class="col-12 text-right">
                                            ...
                                            <a class="btn-gradient-secondary my-1" href="/relation">Batal</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
