...
<div class="col-12 text-right">
    <a class="btn-gradient-primary my-1" href="/relation/create">Tambah Data</a>
</div>
        ...
        <div class="table-responsive">
            <table id="recent-orders" class="table table-hover table-xl mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="text-truncate">{{$rel->instance}}</td>
                        <td class="text-truncate">
                            <img src="/image/{{$rel->image}}" alt="" class="img-fluid" width="100">
                        </td>
                        <td class="text-truncate">
                            <a href="{{ route('relation.edit', $rel->id) }}" class="mb-0 btn-sm btn btn-outline-warning round mb-1">Edit</a>
                            <form action="{{ route('relation.destroy', $rel->id) }}" method="POST">
                                @csrf
                                @method('DELETE')
