                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-md-10 col-12">
                                    <form class="form-horizontal form-user-profile row mt-2" action="{{ route('faq.update', $faq->id) }}" method="POST">
                                        @method('PUT')
                                        @csrf
                                        <div class="col-12">
                                            <fieldset class="form-group">
                                                <label for="question">Pertanyaan</label>
                                                <textarea class="form-control" rows="10" cols="20" id="question" name="question" autofocus="">{{$faq->question}}</textarea>
                                            </fieldset>
                                        </div>
                                        @error('question')
                                        ...
                                        <div class="col-12">
                                            <fieldset class="form-group">
                                                ...
                                                <textarea class="form-control" rows="10" cols="20" id="answer" name="answer" autofocus="">{{$faq->answer}}</textarea>
                                            </fieldset>
                                        </div>
                                        @error('answer')
                                        <small style="color: red;">{{ $message }}</small>
