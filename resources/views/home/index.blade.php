...
<html lang="en">
  <head>
    ...
    <link href="guest/assets/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" />
    ...
    <link href="guest/assets/vendor/aos/aos.css" rel="stylesheet" />

    <!-- Template Main CSS File -->
    <link href="guest/assets/css/main.css" rel="stylesheet" />
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <body>
    ...
    <header id="header" class="header d-flex align-items-center fixed-top">
      <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
        <a href="index.html" class="logo d-flex align-items-center">
          <img src="guest/assets/img/logo pasti.jpg" alt="" />
        </a>
      ...
      <div class="container">
        <div class="row gy-4 d-flex justify-content-between">
          ...
          <div class="col-lg-5 order-1 order-lg-2 hero-img" data-aos="zoom-out">
            <img src="guest/assets/img/hero-img.svg" class="img-fluid mb-3 mb-lg-0" alt="" />
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="container" data-aos="fade-up">
          <div class="row gy-4">
            <div class="col-lg-6 position-relative align-self-start order-lg-last order-first">
              <img src="guest/assets/img/about.png" class="img-fluid" alt="" />
        ...
        <div class="container" data-aos="fade-up">
          ...
          <div class="row gy-4">
            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
              <div class="card">
                <div class="card-img">
                  <img src="guest/assets/img/logo pasti.jpg" alt="" class="img-fluid" />
                </div>
            ...
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="testimonial-item" style="word-spacing: 6em;">
                  <img src="guest/assets/img/testimonials/LOGO_GESANK.png" class="testimonial-img" alt="" />
                  <img src="guest/assets/img/testimonials/LOGO_GESANK.png" class="testimonial-img" alt="" />
                  <img src="guest/assets/img/testimonials/LOGO_GESANK.png" class="testimonial-img" alt="" />
                  <img src="guest/assets/img/testimonials/LOGO_GESANK.png" class="testimonial-img" alt="" />
                </div>
    ...
    <script src="guest/assets/vendor/purecounter/purecounter_vanilla.js"></script>
    ...
    <script src="guest/assets/vendor/aos/aos.js"></script>
