                        ...
                        <div class="col-12">
                            <div class="row">
                                <div class="col-md-10 col-12">
                                    <form class="form-horizontal form-user-profile row mt-2" action="{{ route('about.update', $about->id) }}" method="POST" enctype="multipart/form-data">
                                        @method('PUT')
                                        @csrf
                                        <div class="col-8">
                                            <fieldset class="form-group">
                                                <label for="title">Kategori</label>
                                                <input type="text" class="form-control" name="title" autofocus="" value="{{$about->title}}" disabled>
                                            </fieldset>
                                        </div>
                                        @error('title')
                                        ...
                                        <div class="col-12">
                                            <fieldset class="form-group">
                                                ...
                                                <textarea class="form-control" rows="10" cols="20" id="description" name="description" autofocus="">{{$about->description}}</textarea>
                                            </fieldset>
                                        </div>
                                        @error('description')
                                        <small style="color: red;">{{ $message }}</small>
                                        ...
                                        <img src="/image/{{$about->image}}" alt="" class="img-fluid" width="300">
                                        <div class="col-6">
                                            <fieldset class="form-group">
